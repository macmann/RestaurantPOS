...
export type RepositoryNamespace = 'orders' | 'billing:bills' | 'billing:debt' | 'billing:audit' | 'inventory:items' | 'inventory:movements' | 'menu:categories' | 'menu:items' | 'kds:items' | 'audit:events' | 'users';
